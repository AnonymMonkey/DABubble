...
import { provideFirebaseApp, initializeApp } from '@angular/fire/app'; // AngularFire version
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideFirebaseApp(() => initializeApp(firebaseConfig)), // AngularFire
    provideAuth(() => getAuth()), // AngularFire Auth
    provideFirestore(() => getFirestore()), // AngularFire Firestore
    provideDatabase(() => getDatabase()), // AngularFire Realtime Database
    provideStorage(() => getStorage()), // AngularFire Storage
  ],
};
