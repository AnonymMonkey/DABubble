...
@Component({
  ...
  standalone: true,
  imports: [MatCardModule, NgIf, NgClass, ThreadComponent, MessageAreaHeaderComponent, MessageAreaChatHistoryComponent, MessageAreaNewMessageComponent, MatSidenavModule ],
