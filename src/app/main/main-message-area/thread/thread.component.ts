...
@Component({
  selector: 'app-thread',
  standalone: true,
  imports: [ThreadHeaderComponent, MessageAreaChatHistoryComponent, MessageAreaNewMessageComponent, OwnMessageTemplateComponent, OtherMessageTemplateComponent],
